...
export type ProcessType = "llc_formation" | "bank_application" | "annual_reports" | "agentes_registrados" | "ticketera_cx" | "other"
...
export const ANNUAL_REPORTS_DATA: AnnualReportTask[] = [
  { id: "ar-001", name: "Annual Report - Rodriguez Holdings", entity_name: "Rodriguez Holdings LLC", due_date: "2026-06-15", filed_date: "2026-05-10", status: "completado", state: "new_mexico", package: "pro", assignee: "Maria Garcia" },
  { id: "ar-002", name: "Annual Report - Tech Solutions", entity_name: "Tech Solutions Corp", due_date: "2026-05-30", filed_date: null, status: "proximo_a_hacer", state: "wyoming", package: "all_in", assignee: "Carlos Martinez" },
  { id: "ar-003", name: "Annual Report - Green Energy", entity_name: "Green Energy Partners LLC", due_date: "2026-04-15", filed_date: null, status: "pendiente", state: "delaware", package: "starter", assignee: "Ana Lopez" },
  { id: "ar-004", name: "Annual Report - Sunset Inv", entity_name: "Sunset Investments LLC", due_date: "2026-07-20", filed_date: "2026-07-01", status: "completado", state: "florida", package: "solo_llc", assignee: "Maria Garcia" },
  { id: "ar-005", name: "Annual Report - Blue Ocean", entity_name: "Blue Ocean Ventures LLC", due_date: "2026-05-25", filed_date: null, status: "proximo_a_hacer", state: "texas", package: "pro", assignee: "Roberto Sanchez" },
  { id: "ar-006", name: "Annual Report - Mountain Peak", entity_name: "Mountain Peak LLC", due_date: "2026-08-10", filed_date: "2026-07-28", status: "completado", state: "new_mexico", package: "all_in", assignee: "Carlos Martinez" },
  { id: "ar-007", name: "Annual Report - Coastal Props", entity_name: "Coastal Properties LLC", due_date: "2026-06-01", filed_date: null, status: "proximo_a_hacer", state: "wyoming", package: "starter", assignee: "Ana Lopez" },
  { id: "ar-008", name: "Annual Report - Digital Nomads", entity_name: "Digital Nomads Co LLC", due_date: "2026-09-15", filed_date: "2026-08-20", status: "completado", state: "delaware", package: "pro", assignee: "Maria Garcia" },
  { id: "ar-009", name: "Annual Report - River Valley", entity_name: "River Valley Holdings LLC", due_date: "2026-05-01", filed_date: null, status: "pendiente", state: "florida", package: "solo_llc", assignee: "Roberto Sanchez" },
  { id: "ar-010", name: "Annual Report - Urban Dev", entity_name: "Urban Development Group LLC", due_date: "2026-07-10", filed_date: "2026-06-25", status: "completado", state: "texas", package: "starter", assignee: "Carlos Martinez" },
  { id: "ar-011", name: "Annual Report - Pacific Traders", entity_name: "Pacific Traders LLC", due_date: "2026-06-20", filed_date: null, status: "proximo_a_hacer", state: "new_mexico", package: "all_in", assignee: "Ana Lopez" },
  { id: "ar-012", name: "Annual Report - Sunshine Rentals", entity_name: "Sunshine Rentals LLC", due_date: "2026-08-05", filed_date: "2026-07-15", status: "completado", state: "wyoming", package: "pro", assignee: "Maria Garcia" },
]
...
export const AGENTES_REGISTRADOS_DATA: AgenteRegistradoTask[] = [
  { id: "ag-001", name: "Agente - Rodriguez Holdings", entity_name: "Rodriguez Holdings LLC", state: "new_mexico", package: "pro", renewal_date: "2027-03-01", status: "completado", assignee: "Maria Garcia" },
  { id: "ag-002", name: "Agente - Tech Solutions", entity_name: "Tech Solutions Corp", state: "wyoming", package: "all_in", renewal_date: "2026-06-15", status: "esperando_invoice", assignee: "Carlos Martinez" },
  { id: "ag-003", name: "Agente - Green Energy", entity_name: "Green Energy Partners LLC", state: "delaware", package: "starter", renewal_date: "2026-04-01", status: "pendiente", assignee: "Ana Lopez" },
  { id: "ag-004", name: "Agente - Sunset Investments", entity_name: "Sunset Investments LLC", state: "florida", package: "solo_llc", renewal_date: "2027-01-20", status: "completado", assignee: "Maria Garcia" },
  { id: "ag-005", name: "Agente - Blue Ocean", entity_name: "Blue Ocean Ventures LLC", state: "texas", package: "pro", renewal_date: "2026-05-30", status: "esperando_invoice", assignee: "Roberto Sanchez" },
  { id: "ag-006", name: "Agente - Mountain Peak", entity_name: "Mountain Peak LLC", state: "new_mexico", package: "all_in", renewal_date: "2027-02-10", status: "completado", assignee: "Carlos Martinez" },
  { id: "ag-007", name: "Agente - Coastal Props", entity_name: "Coastal Properties LLC", state: "wyoming", package: "starter", renewal_date: "2026-06-01", status: "esperando_invoice", assignee: "Ana Lopez" },
  { id: "ag-008", name: "Agente - Digital Nomads", entity_name: "Digital Nomads Co LLC", state: "delaware", package: "pro", renewal_date: "2027-04-15", status: "completado", assignee: "Maria Garcia" },
  { id: "ag-009", name: "Agente - River Valley", entity_name: "River Valley Holdings LLC", state: "florida", package: "solo_llc", renewal_date: "2026-03-15", status: "pendiente", assignee: "Roberto Sanchez" },
  { id: "ag-010", name: "Agente - Urban Dev", entity_name: "Urban Development Group LLC", state: "texas", package: "starter", renewal_date: "2027-01-10", status: "completado", assignee: "Carlos Martinez" },
]

// CX Tickets Mock Data
export const CX_TICKETS_DATA: CXTicket[] = [
  { id: "cx-001", subject: "Consulta sobre estado de LLC", client_name: "Rodriguez Holdings", created_at: "2026-05-10T09:30:00", first_response_at: "2026-05-10T10:15:00", resolved_at: "2026-05-10T14:00:00", status: "cerrado", priority: "media", state: "new_mexico", package: "pro", assignee: "Laura Fernandez" },
  { id: "cx-002", subject: "Problema con documentos EIN", client_name: "Tech Solutions", created_at: "2026-05-12T11:00:00", first_response_at: "2026-05-12T11:20:00", resolved_at: null, status: "en_progreso", priority: "alta", state: "wyoming", package: "all_in", assignee: "Pedro Ramirez" },
  { id: "cx-003", subject: "Actualizacion de datos", client_name: "Green Energy", created_at: "2026-05-13T08:45:00", first_response_at: null, resolved_at: null, status: "abierto", priority: "baja", state: "delaware", package: "starter", assignee: "Laura Fernandez" },
  { id: "cx-004", subject: "Solicitud de Annual Report", client_name: "Sunset Investments", created_at: "2026-05-11T14:20:00", first_response_at: "2026-05-11T14:35:00", resolved_at: "2026-05-11T16:00:00", status: "resuelto", priority: "media", state: "florida", package: "solo_llc", assignee: "Pedro Ramirez" },
  { id: "cx-005", subject: "Error en facturacion", client_name: "Blue Ocean", created_at: "2026-05-14T10:00:00", first_response_at: "2026-05-14T10:10:00", resolved_at: null, status: "en_progreso", priority: "alta", state: "texas", package: "pro", assignee: "Laura Fernandez" },
  { id: "cx-006", subject: "Cambio de agente registrado", client_name: "Mountain Peak", created_at: "2026-05-09T16:30:00", first_response_at: "2026-05-09T16:45:00", resolved_at: "2026-05-10T09:00:00", status: "cerrado", priority: "media", state: "new_mexico", package: "all_in", assignee: "Pedro Ramirez" },
  { id: "cx-007", subject: "Consulta sobre renovacion", client_name: "Coastal Properties", created_at: "2026-05-14T09:15:00", first_response_at: null, resolved_at: null, status: "abierto", priority: "media", state: "wyoming", package: "starter", assignee: "Laura Fernandez" },
  { id: "cx-008", subject: "Urgente: Documento faltante", client_name: "Digital Nomads", created_at: "2026-05-14T08:00:00", first_response_at: "2026-05-14T08:05:00", resolved_at: null, status: "en_progreso", priority: "alta", state: "delaware", package: "pro", assignee: "Pedro Ramirez" },
  { id: "cx-009", subject: "Informacion de cuenta bancaria", client_name: "River Valley", created_at: "2026-05-13T13:00:00", first_response_at: "2026-05-13T13:30:00", resolved_at: "2026-05-13T15:00:00", status: "resuelto", priority: "baja", state: "florida", package: "solo_llc", assignee: "Laura Fernandez" },
  { id: "cx-010", subject: "Pregunta sobre paquetes", client_name: "Urban Dev", created_at: "2026-05-14T11:30:00", first_response_at: null, resolved_at: null, status: "abierto", priority: "baja", state: "texas", package: "starter", assignee: "Pedro Ramirez" },
  { id: "cx-011", subject: "Reenvio de certificados", client_name: "Pacific Traders", created_at: "2026-05-12T15:00:00", first_response_at: "2026-05-12T15:10:00", resolved_at: "2026-05-12T17:00:00", status: "cerrado", priority: "media", state: "new_mexico", package: "all_in", assignee: "Laura Fernandez" },
  { id: "cx-012", subject: "Cancelacion de servicio", client_name: "Sunshine Rentals", created_at: "2026-05-13T10:45:00", first_response_at: "2026-05-13T11:00:00", resolved_at: null, status: "en_progreso", priority: "alta", state: "wyoming", package: "pro", assignee: "Pedro Ramirez" },
]
...
export function calculateBottleneckAnalysis(tasks: BankTask[]) {
  const comparisonData = tasks.map((task) => {
    ...
    const clientDays = einWaitDays + verifWaitDays + (task.time_in_status["ESPERANDO INPUT CLIENTE"] || 0)
    ...
    const isPending = !cf.fecha_aplicacion || (!cf.fecha_aprob_rech && task.status !== "CUENTA ABIERTA" && task.status !== "RECHAZADA")
    const statusLabel = isPending ? "En curso" : task.status

    return {
      name: task.name.replace("Cuenta Mercury - ", "").replace("Cuenta Relay - ", "").replace("Cuenta Lili - ", ""),
  ...
  const clientResponsibilityRatio = totalDays > 0 ? Math.round((totalClientDays / totalDays) * 100) : 0
...
export function calculateCycleTimeKPIs(tasks: Task[]) {
  ...
  const inProgressTasks = tasks.filter((t) => t.status !== "EIN LISTO" && t.status !== "PENDIENTE").length
  const avgLeadTime = calculateLeadTime(tasks)

  const einWaitTasks = tasks.filter(
    (t) => t.time_in_status["ESPERANDO EIN"] !== undefined
  )
  const avgEINWait =
  ...
  const delayedTasks = tasks.filter((t) => {
    ...
    return intermediateStatuses.some(
      (status) => (t.time_in_status[status] || 0) > 5
    )
  }).length
...
export function calculateCXTicketsKPIs(tickets: CXTicket[]) {
  ...
  const abiertos = tickets.filter((t) => t.status === "abierto" || t.status === "en_progreso").length
